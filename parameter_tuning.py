...
from GA.evolution_utils import X_bow, y_score, X_train, X_test, Y_train, Y_test
from GA.evolution_utils import logmodel, X_train, Y_train, X_test, Y_test, accuracy_score, all_models_score_table
